...
/**
 * <p>
 * Java class for c-abs-item-type complex type.
 * 
 * <p>
...
@XmlType(name = "c-abs-item-type", propOrder = { "outgoingLink", "attributeType", "attributeDefinition",
		"attributeValue", "metaAttribute", "creationPages", "modificationPages", "action", "menu", "actionContributor",
		"constraints" })
@XmlSeeAlso( { CItemType.class, CExtensionItemType.class })
public abstract class CAbsItemType extends CItem {
	 ...
	 * <CODE>set</CODE> method for the outgoingLink property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the attributeDefinition property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link CAttType }
	 * 
	 * 
	 */
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the metaAttribute property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 * @return possible object is {@link CPages }
	 * 
	 */
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link CAction }
	 * 
	 * 
	 */
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the actionContributor property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the constraints property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
